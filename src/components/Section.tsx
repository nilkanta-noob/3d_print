...
// Page section with the site's spacing system and container. scroll-mt-16 keeps anchor jumps clear of the fixed navbar.
export default function Section({ id, tone = 'base', compact = false, className = '', children }: SectionProps) {
  ...
  return (
    <section id={id} className={`scroll-mt-16 ${spacing} ${toneClass} ${className}`}>
